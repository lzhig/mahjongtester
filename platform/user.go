...
func (user *UserT) initialize() error {
...
func (user *UserT) PlayGame(appid string) {

}

func (user *UserT) getHashInfo() (*hashInfoT, error) {
...
func (user *UserT) LoginPlatform() error {
...
func (user *UserT) GetGameInfo(gameAppID string) (uint32, string, int64, string, string, error) {
...
func (user *UserT) AssetsIn(gameid string, currency string, amount uint64, roomid uint64, roomDesc string, token string) (*assetsInResponseT, error) {
...
func (user *UserT) GetBalance() (cash uint64, nm uint64, coin uint64, err error) {
